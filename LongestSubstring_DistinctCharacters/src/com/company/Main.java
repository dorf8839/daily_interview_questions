...
public class Main {
    ...
    //using an associative array count[].  Returns true if no.
    //of characters are less than required, else returns false
    ...
    public static void kUniques(String s, int k){
        ...
        //Otherwise, take a window with first element
        //in it. Start and end variables
        ...
        //in window according to above explanation
        for(int i = 1; i < n; i++){
            ...
            //in current window, remove from left side
